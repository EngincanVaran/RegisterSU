...
class App extends Component {
  state = { loaded: false, cost: 0, itemName: "item_name" };
  ...
  listenToPaymentEvent = () => {
    ...
    this.itemManager.events.SupplyChainStep().on("data", async function (event) {
      ...
      alert("Item " + itemObj._identifier + " was paid! Let's deliver!")
    })
  }
  ...
  render() {
    ...
    return (
      <div className="App">
        ...
        Item Name: <input type="text" name="name" value={this.state.itemName} onChange={this.handleInputChange} />
        <button type="button" onClick={this.handleClick}>Create New Item</button>
      </div>
    );
  }
}
